...
export default class Player extends Vue {
  ...
  private mounted() {
    const activeTile = document.getElementById(String(this.player.tile))!.getBoundingClientRect();
...
.orange {
  filter: invert(9%) sepia(86%) saturate(2504%) hue-rotate(349deg) brightness(98%) contrast(118%);
}
.green {
  filter: invert(10%) sepia(71%) saturate(6473%) hue-rotate(118deg) brightness(93%) contrast(108%);
}
.purple {
  filter: invert(6%) sepia(74%) saturate(6792%) hue-rotate(245deg) brightness(69%) contrast(120%);
}
.black {
}
.dafuq {
  filter: invert(100%) sepia(0%) saturate(7500%) hue-rotate(56deg) brightness(100%) contrast(103%);
}
</style>
